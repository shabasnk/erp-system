...
// import {calculateSubtotal, calculateGst } from './utils';
...
// fr solving error after done shop owner based rprt
// // src/components/billing/BillingNav.tsx
// import React, { useState, useEffect, useRef } from 'react';
// import { useOutletContext } from 'react-router-dom';
// import { debounce } from 'lodash';
...
//       // Create customer with shopId from authenticated user
//       const customerResponse = await authAxios.post('/customer/create', {
//         companyName: customerInfo.companyName,
//         name: customerInfo.name,
//         email: customerInfo.email,
...
//         gstNumber: customerInfo.gstNumber,
//         useSameAsPhone: customerInfo.useSameAsPhone,
//         shopId: user?.shopId // Add shopId from authenticated user
//       });
...
//     // Create invoice with shopId from authenticated user
//     // In your handleCheckout function, find this section:
// const invoiceResponse = await authAxios.post('/billing/create', {
//   products: selectedProducts,
//   customerId,
//   paymentMethod,
//   total: calculateTotal(),
//   gstPercentage: customerInfo.gstNumber ? customerInfo.gstPercentage : null,
//   shopId: user?.shopId // Add this line right here
// });
...
const BillingNav: React.FC = () => {
  ...
  // Checkout handler - UPDATED: Removed shopId from requests
  const handleCheckout = async () => {
    if (!isAuthenticated) {
      resetNotificationStates();
      setErrorMessage('Please login to complete checkout');
    ...
    try {
      ...
      // Create customer (shopId is handled by backend from token)
      const customerResponse = await authAxios.post('/customer/create', {
        companyName: customerInfo.companyName,
        name: customerInfo.name,
        email: customerInfo.email,
      ...
      // Create invoice (shopId is handled by backend from token)
      const invoiceResponse = await authAxios.post('/billing/create', {
        products: selectedProducts,
        customerId,
        paymentMethod,
