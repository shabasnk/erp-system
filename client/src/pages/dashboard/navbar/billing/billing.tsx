...
//     // Show customer success popup immediately
//     setShowCustomerSuccess(true);
//     setCustomerSuccessTimer(setTimeout(() => setShowCustomerSuccess(false), 3000));
...
//         setShowSuccessNotification(false);
//         setShowCustomerSuccess(false); // Ensure customer success is also hidden
//       }, 5000));
//     } else {
//       throw new Error(invoiceResponse.data?.message || 'Invoice creation failed');
//     }
//   } catch (err) {
//     console.error('Checkout error:', err);
//     const message = axios.isAxiosError(err) 
