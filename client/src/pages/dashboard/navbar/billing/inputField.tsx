    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          value={customerInfo.companyName}
          onChange={(e) => handleChange('companyName', e.target.value)}
          className={`w-full p-3 rounded-lg border ${darkMode ? 'bg-gray-700 border-pink-900 text-white focus:border-pink-500' : 'bg-white border-pink-200 focus:border-pink-300'} ${showValidation && !isCompanyNameValid ? 'border-red-500' : ''} transition-colors duration-300`}
          required
        />
        {showValidation && !isCompanyNameValid && (
          <p className={`mt-1 text-xs ${darkMode ? 'text-red-400' : 'text-red-600'}`}>
      ...
      <div>
        ...
        <input
          ...
          value={customerInfo.name}
          onChange={(e) => handleChange('name', e.target.value)}
          className={`w-full p-3 rounded-lg border ${darkMode ? 'bg-gray-700 border-pink-900 text-white focus:border-pink-500' : 'bg-white border-pink-200 focus:border-pink-300'} ${showValidation && !isNameValid ? 'border-red-500' : ''} transition-colors duration-300`}
          required
        />
        {showValidation && !isNameValid && (
          <p className={`mt-1 text-xs ${darkMode ? 'text-red-400' : 'text-red-600'}`}>
      ...
      <div>
        ...
        <input
          ...
          value={customerInfo.email}
          onChange={(e) => handleChange('email', e.target.value)}
          className={`w-full p-3 rounded-lg border ${darkMode ? 'bg-gray-700 border-pink-900 text-white focus:border-pink-500' : 'bg-white border-pink-200 focus:border-pink-300'} ${showValidation && !isEmailValid ? 'border-red-500' : ''} transition-colors duration-300`}
          required
        />
        {showValidation && !isEmailValid && (
          <p className={`mt-1 text-xs ${darkMode ? 'text-red-400' : 'text-red-600'}`}>
      ...
      <div>
        ...
        <input
          ...
          value={customerInfo.phone}
          onChange={(e) => handleChange('phone', e.target.value)}
          className={`w-full p-3 rounded-lg border ${darkMode ? 'bg-gray-700 border-pink-900 text-white focus:border-pink-500' : 'bg-white border-pink-200 focus:border-pink-300'} ${showValidation && !isPhoneValid ? 'border-red-500' : ''} transition-colors duration-300`}
          required
          maxLength={10}
        />
        {showValidation && !isPhoneValid && (
      ...
      <div>
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            onChange={(e) => handleChange('whatsappNumber', e.target.value)}
            disabled={customerInfo.useSameAsPhone}
            className={`w-full p-3 rounded-lg border ${darkMode ? 'bg-gray-700 border-pink-900 text-white focus:border-pink-500' : 'bg-white border-pink-200 focus:border-pink-300'} ${customerInfo.useSameAsPhone ? 'opacity-50' : ''} ${showValidation && !isWhatsappValid ? 'border-red-500' : ''} transition-colors duration-300`}
            required
            maxLength={10}
          />
          <div className="flex items-center">
      ...
      <div>
        ...
        <textarea
          value={customerInfo.address}
          onChange={(e) => handleChange('address', e.target.value)}
          className={`w-full p-3 rounded-lg border ${darkMode ? 'bg-gray-700 border-pink-900 text-white focus:border-pink-500' : 'bg-white border-pink-200 focus:border-pink-300'} ${showValidation && !isAddressValid ? 'border-red-500' : ''} transition-colors duration-300`}
          rows={3}
          required
        />
        {showValidation && !isAddressValid && (
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) => handleChange('gstNumber', e.target.value.toUpperCase())}
          placeholder="22AAAAA0000A1Z5"
          className={`w-full p-3 rounded-lg border ${darkMode ? 'bg-gray-700 border-pink-900 text-white focus:border-pink-500' : 'bg-white border-pink-200 focus:border-pink-300'} ${showValidation && !isGSTValid ? 'border-red-500' : ''} transition-colors duration-300`}
        />
        {showValidation && !isGSTValid && (
          <p className={`mt-1 text-xs ${darkMode ? 'text-red-400' : 'text-red-600'}`}>
            Please enter a valid GST number (format: 22AAAAA0000A1Z5)
      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            onChange={(e) => handleGSTPercentageChange(e.target.value)}
            placeholder="0-100%"
            className={`w-full p-3 rounded-lg border ${darkMode ? 'bg-gray-700 border-pink-900 text-white focus:border-pink-500' : 'bg-white border-pink-200 focus:border-pink-300'} ${showValidation && !isGSTPercentageValid ? 'border-red-500' : ''} transition-colors duration-300`}
          />
