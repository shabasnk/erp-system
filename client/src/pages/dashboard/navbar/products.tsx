        ...
        <div className={`p-6 rounded-lg ${darkMode ? 'bg-gray-800/50 border border-pink-900' : 'bg-pink-50 border border-pink-100'}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[1, 2, 3].map((product) => (
              ...
              >
                <div className={`h-40 ${darkMode ? 'bg-gray-700' : 'bg-gray-100'} rounded-md mb-3 flex items-center justify-center`}>
                  <span className={`${darkMode ? 'text-gray-500' : 'text-gray-400'}`}>Product Image</span>
                </div>
